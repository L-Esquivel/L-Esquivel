...
- **Impact**: Optimized bakery operations by 95% in calculation speed and 90% in manual tasks.
- [Explore the Repository](https://github.com/L-Esquivel/Precivox)

### 📚 Professional Certifications (2026 Cohort)

* **Completed ✅**: Google AI Professional | Cisco IT Support Specialist | Power BI Interactive Dashboards | Foundations of Cybersecurity.
* **In Progress ⏳**: AWS Certified Junior Software Developer | Google Project Management Professional | Google Cybersecurity Professional | Google Cloud Security.
